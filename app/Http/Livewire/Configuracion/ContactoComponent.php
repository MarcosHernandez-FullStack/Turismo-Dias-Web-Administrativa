...
class ContactoComponent extends Component
{
    ...
    protected $rules = [
        ...
        'configuracion.link_twitter' => 'nullable|url|max:50',
    ...
    protected $messages = [
        ...
        'configuracion.correo_principal.email' => 'El correo principal debe tener formato de correo "email@ejemplo.com".',
        ...
        'configuracion.correo_secundario.email' => 'El correo secundario debe tener formato de correo "email@ejemplo.com".',
        ...
        'configuracion.link_twitter.max' => 'El link de Twitter debe tener un máximo de 50 caracteres.',
        ...
        'configuracion.link_twitter.url' => 'El link de Twitter debe ser una URL.',
