    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
      <div class="modal-content">
              ...
              <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link @if ($tab=='ruta_foto_principal_tab') active @endif" id="ruta_foto_principal_tab"
                    data-toggle="pill" href="#ruta_foto_principal_tabContent"
                ...
                <li class="nav-item">
                  <a class="nav-link  @if ($tab=='ruta_video_tab') active @endif" id="ruta_video_tab" data-toggle="pill"
                    href="#ruta_video_tabContent" wire:click="cambiarTab('ruta_video_tab');" role="tab"
                ...
                <li class="nav-item">
                  <a class="nav-link  @if ($tab=='ruta_foto_header_seccion_tab') active @endif"
                    ...
                    aria-controls="ruta_foto_header_seccion_tabContent" aria-selected="false">Encabezado</a>
                </li>
              </ul>
            </div>
            <div class="card-body">
                ...
                <div class="tab-pane fade @if ($tab=='ruta_video_tab') active show @endif" id="ruta_video_tabContent"
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" wire:model='configuracion.ruta_video'
                      class="form-control @error('configuracion.ruta_video') is-invalid @enderror" id="ruta_video"
                      placeholder="Ingresar URL del video a mostrar">
                    @error('configuracion.ruta_video')
                    <span id="ruta_video-error" class="error invalid-feedback">{{$message}}</span>
                    @enderror
                  </div>
                  <div class="row">
                    <div class="col-12">
                      <div class="contenedor-video">
                        ...
                        <iframe width="640" height="360" src="{{ $this->configuracion->ruta_video }}"
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-sm rounded-pill btn-info" wire:click="save"><i class="fas fa-save"
