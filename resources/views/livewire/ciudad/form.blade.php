            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" wire:model='ciudad.descripcion' class="form-control @error('ciudad.descripcion') is-invalid @enderror"
                            id="descripcion" rows="2" placeholder="Ingresar Descripción de la Ciudad">
