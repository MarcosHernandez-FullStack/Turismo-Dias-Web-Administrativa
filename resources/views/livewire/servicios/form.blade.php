                ...
                <div class="col-12">
                    ...
                    <div class="row p-0 m-0">
                        <div class="col-12 p-0 m-0 d-flex justify-content-center">
                            <div class="contenedor-imagen-servicio" style="height: 200px!important;width: 280px!important;">
                                @if (isset($ruta_foto))
                                <img src="{{ $ruta_foto->temporaryUrl() }}" alt="...">
                                @elseif (isset($servicio->ruta_foto))
                                <img src="{{ Storage::url($servicio->ruta_foto) }}"
                                  alt="...">
                                @else
