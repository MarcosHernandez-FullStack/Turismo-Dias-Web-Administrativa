    ...
    <form>
        <div class="modal-header bg-info text-light">
            <h5 class="modal-title">
                Ver {{ $this->reclamo->tipo_reclamacion_detalle != '3' ? 'Reclamo' : 'Mensaje' }}
            </h5>
        ...
        <div class="modal-body">
            @if ($this->reclamo->tipo_reclamacion_detalle != '3')
                        ...
                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  @if ($tab == 'bien_servicio') active @endif" id="bien_servicio"
                                    data-toggle="pill" href="#bien_servicioContent"
                                    wire:click="cambiarTab('bien_servicio');" role="tab"
                                    aria-controls="bien_servicioContent" aria-selected="false">Producto/Servicio</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link  @if ($tab == 'detalle') active @endif" id="detalle"
                                    data-toggle="pill" href="#detalleContent" wire:click="cambiarTab('detalle');"
                                    role="tab" aria-controls="detalleContent" aria-selected="false">Detalle del
                                    Reclamo</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ $this->reclamo->documento_identidad_consumidor }}" disabled
                                                class="form-control" id="documento_identidad_consumidor">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $this->reclamo->direccion_consumidor }}"
                                                disabled class="form-control" id="direccion_consumidor">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="nombre_completo_apoderado_consumidor">Tutor (Menores de
                                                Edad)</label>
                                            <input type="text"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ $this->reclamo->tipo_bien == 1 ? 'Producto' : 'Servicio' }}"
                                                disabled class="form-control" id="tipo_bien">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="monto_reclamado_bien">Monto</label>
                                            <input type="text" value="{{ $this->reclamo->monto_reclamado_bien }}"
                                                disabled class="form-control" id="monto_reclamado_bien">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
            ...
            @else
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            <label for="documento_identidad_consumidor">DNI / CE</label>
                            <input type="text" value="{{ $this->reclamo->documento_identidad_consumidor }}" disabled
                                class="form-control" id="documento_identidad_consumidor">
                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-sm rounded-pill btn-info"wire:loading.attr="disabled"
                wire:target="save" wire:click="save"> <i class="fas fa-save"></i>
                Actualizar</button>
        </div>
    </form>
@endsection
