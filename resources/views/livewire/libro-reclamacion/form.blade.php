        ...
        <div class="card card-primary card-tabs">
            <div class="card-header p-0 pt-1 bg-info text-light">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link @if ($tab=='reclamante') active @endif" id="reclamante" data-toggle="pill"
                            href="#reclamanteContent" wire:click="cambiarTab('reclamante');" role="tab"
                            aria-controls="reclamanteContent" aria-selected="true">Datos del reclamante</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  @if ($tab=='bien_servicio') active @endif" id="bien_servicio"
                            ...
                            role="tab" aria-controls="bien_servicioContent" aria-selected="false">Producto/Servicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  @if ($tab=='detalle') active @endif" id="detalle" data-toggle="pill"
                            href="#detalleContent" wire:click="cambiarTab('detalle');" role="tab"
            ...
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                    <div class="tab-pane fade @if ($tab=='reclamante') active show @endif" id="reclamanteContent"
                        role="tabpanel" aria-labelledby="reclamanteContent-tab">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="nombre_completo_consumidor">Nombre del Reclamante</label>
                                    <input type="text" value="{{ $this->reclamo->nombre_completo_consumidor }}" disabled
                                        class="form-control" id="nombre_completo_consumidor">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="tab-pane fade @if ($tab=='bien_servicio') active show @endif" id="bien_servicioContent"
                        role="tabpanel" aria-labelledby="bien_servicioContent-tab">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                    ...
                    <div class="tab-pane fade @if ($tab=='detalle') active show @endif" id="detalleContent"
                        role="tabpanel" aria-labelledby="detalleContent-tab">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="tipo_reclamacion_detalle">Tipo</label>
                                    <input type="text" value="{{ $this->reclamo->tipo_reclamacion_detalle ==1 ? 'Reclamo' : 'Queja' }}" disabled
                                        class="form-control" id="tipo_reclamacion_detalle">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea disabled class="form-control" id="descripcion_reclamacion_detalle"
                                        rows="2">{{ $this->reclamo->descripcion_reclamacion_detalle }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea disabled class="form-control" id="pedido_reclamacion_detalle"
                                        rows="2">{{ $this->reclamo->pedido_reclamacion_detalle }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group clearfix">
                                    <div class="icheck-info d-inline">
                                      <input type="radio" id="estado1" name="r1" value="1" checked="" wire:model="reclamo.estado">
                                      <label for="estado1">
                                        En espera
                                      </label>
                                    </div>
                                    <div class="icheck-info d-inline">
                                      <input type="radio" id="estado2" name="r1" value="2" wire:model="reclamo.estado">
                                      <label for="estado2">
                                        Atender
                                      </label>
                                    </div>
                                    <div class="icheck-info d-inline">
                                      <input type="radio" id="estado0" name="r1" value="0" wire:model="reclamo.estado">
                                      <label for="estado0">
                                        Archivar
                                      </label>
                                    </div>
