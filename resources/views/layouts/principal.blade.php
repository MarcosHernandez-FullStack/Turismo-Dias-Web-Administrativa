...
<head>
    ...
    {{--  <link rel="stylesheet" href="{{ asset('assets/plugins/ionicons.min') }}"> --}}
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('assets/img/turismo-dias-logo.png') }}" alt="AdminLTELogo"
                height="80" width="80">
        </div>
      ...
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link" style="justify-content: center; display: flex;">
                <img src="{{ asset('assets/img/turismo-dias-logo.png') }}" style="opacity: .8; width: 216px;height: 82px;">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('assets/img/user-cuy.webp') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
